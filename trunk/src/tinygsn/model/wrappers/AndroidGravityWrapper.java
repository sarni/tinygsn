...
public class AndroidGravityWrapper extends AbstractWrapper implements
		SensorEventListener {
	...
	private static final String TAG = "AndroidGravityWrapper";
	...
	public AndroidGravityWrapper() {
		super();
	}

	public AndroidGravityWrapper(Queue queue) {
		super(queue);
		initialize();
	}
