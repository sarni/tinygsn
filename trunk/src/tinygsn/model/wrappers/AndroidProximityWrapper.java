...
public class AndroidProximityWrapper extends AbstractWrapper implements
		SensorEventListener {

	private static final String[] FIELD_NAMES = new String[] { "distance"};
	...
	private static final String TAG = "AndroidProximityWrapper";
	...
	public AndroidProximityWrapper() {
		super();
	}

	public AndroidProximityWrapper(Queue queue) {
		super(queue);
		initialize();
	}
