...
public class ActivityViewData extends Activity {
	...
	private void addTableViewModeLatest() {
		...
		editText_numLatest.setTextColor(Color.parseColor("#ffffff"));
		...
		plotDataBtn.setTextColor(Color.parseColor("#ffffff"));
...
//		Date time = new Date();
		...
		txtStartDate.setTextColor(Color.parseColor("#ffffff"));
		...
		txtEndTime.setTextColor(Color.parseColor("#ffffff"));
		...
		txtEndDate.setTextColor(Color.parseColor("#ffffff"));
