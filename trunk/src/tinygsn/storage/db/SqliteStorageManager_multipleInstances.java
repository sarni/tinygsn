...
public class SqliteStorageManager_multipleInstances extends StorageManager {

	private static final String DB_NAME = "tinygsn8.db";
	...
	public ArrayList<VirtualSensor> getListofVS() {
		...
		try {
			...
			while (cursor.moveToNext()) {
				...
				boolean save_to_db = cursor.getString(
						cursor.getColumnIndex("save_to_db")).equals("true");
